...
internal fun Project.configureJacoco() {
    ...
    tasks.register<JacocoReport>("debugCoverage") {
        ...
        val jClasses = layout.buildDirectory.dir("intermediates/javac/debug/classes").get().asFile
        val kClasses = layout.buildDirectory.dir("tmp/kotlin-classes/debug").get().asFile
        ...
        executionData.setFrom(
            files(
                listOf(layout.buildDirectory.file("jacoco/testDebugUnitTest.exec").get().asFile),
            ),
        )
    }
